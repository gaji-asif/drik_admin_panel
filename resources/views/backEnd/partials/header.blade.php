<title>EDMS</title>
  ...
  <!-- start css for select2 dropdown -->
   ...
   <!--   end css for select2 dropdown -->
    ...
    <link rel="stylesheet" href="{{asset("public/drik/css/all.min.css")}}">
    <link rel="stylesheet" href="{{asset("public/drik/css/style.css")}}">
    <link rel="stylesheet" href="{{asset("public/drik/css/responsive.css")}}">
